...
fork1(void)
{
  ...
  exit();
     ...
     10b:	68 b5 12 00 00       	push   $0x12b5
     110:	6a 02                	push   $0x2
    ...
    panic("fork");
     ...
     122:	68 3b 12 00 00       	push   $0x123b
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 a9 12 00 00       	push   $0x12a9
     17e:	6a 02                	push   $0x2
...
00000190 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1a9:	ff 24 85 e4 12 00 00 	jmp    *0x12e4(,%eax,4)
    printf(2, "Pipe Not implemented\n");
     1b0:	52                   	push   %edx
     1b1:	52                   	push   %edx
     1b2:	68 25 12 00 00       	push   $0x1225
     1b7:	6a 02                	push   $0x2
     1b9:	e8 f2 0c 00 00       	call   eb0 <printf>
    break;
    ...
    printf(2, "Backgrounding not implemented\n");
     1cd:	50                   	push   %eax
     1ce:	50                   	push   %eax
     1cf:	68 c4 12 00 00       	push   $0x12c4
     1d4:	6a 02                	push   $0x2
     1d6:	e8 d5 0c 00 00       	call   eb0 <printf>
    break;
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1f9:	68 e2 11 00 00       	push   $0x11e2
     1fe:	6a 02                	push   $0x2
     200:	e8 ab 0c 00 00       	call   eb0 <printf>
    break;
    ...
    printf(2, "Redirection Not Implemented\n");
     20a:	53                   	push   %ebx
     20b:	53                   	push   %ebx
     20c:	68 f2 11 00 00       	push   $0x11f2
     211:	6a 02                	push   $0x2
     213:	e8 98 0c 00 00       	call   eb0 <printf>
    break;
    ...
    printf(2, "List Not Implemented\n");
     21d:	51                   	push   %ecx
     21e:	51                   	push   %ecx
     21f:	68 0f 12 00 00       	push   $0x120f
     224:	6a 02                	push   $0x2
     226:	e8 85 0c 00 00       	call   eb0 <printf>
    break;
     22b:	83 c4 10             	add    $0x10,%esp
     22e:	eb 98                	jmp    1c8 <runcmd+0x38>
    panic("runcmd");
     230:	83 ec 0c             	sub    $0xc,%esp
     233:	68 db 11 00 00       	push   $0x11db
...
00000240 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     255:	68 3b 12 00 00       	push   $0x123b
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     267:	6a 54                	push   $0x54
     269:	e8 82 0e 00 00       	call   10f0 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     297:	6a 18                	push   $0x18
     299:	e8 52 0e 00 00       	call   10f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     2e7:	6a 0c                	push   $0xc
     2e9:	e8 02 0e 00 00       	call   10f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     327:	6a 0c                	push   $0xc
     329:	e8 c2 0d 00 00       	call   10f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     399:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     3bd:	50                   	push   %eax
     3be:	68 2c 19 00 00       	push   $0x192c
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     40d:	50                   	push   %eax
     40e:	68 2c 19 00 00       	push   $0x192c
  ...
  *ps = s;
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     456:	50                   	push   %eax
     457:	68 24 19 00 00       	push   $0x1924
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     475:	50                   	push   %eax
     476:	68 2c 19 00 00       	push   $0x192c
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     52d:	50                   	push   %eax
     52e:	68 2c 19 00 00       	push   $0x192c
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     593:	68 5d 12 00 00       	push   $0x125d
     598:	53                   	push   %ebx
     599:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     5f0:	6a 18                	push   $0x18
     5f2:	e8 f9 0a 00 00       	call   10f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     64f:	6a 18                	push   $0x18
     651:	e8 9a 0a 00 00       	call   10f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
     ...
     6ae:	68 40 12 00 00       	push   $0x1240
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     6cf:	68 60 12 00 00       	push   $0x1260
     6d4:	56                   	push   %esi
     6d5:	53                   	push   %ebx
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     6eb:	6a 54                	push   $0x54
     6ed:	e8 fe 09 00 00       	call   10f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     736:	68 77 12 00 00       	push   $0x1277
     73b:	56                   	push   %esi
     73c:	53                   	push   %ebx
    ...
    if(argc >= MAXARGS)
     ...
     780:	68 69 12 00 00       	push   $0x1269
  ...
  cmd->eargv[argc] = 0;
     ...
     7c9:	68 62 12 00 00       	push   $0x1262
...
000007e0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7f9:	68 7c 12 00 00       	push   $0x127c
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
     83d:	e8 ae 08 00 00       	call   10f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000870 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     8a2:	e8 49 08 00 00       	call   10f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
     ...
     8cb:	68 7e 12 00 00       	push   $0x127e
     8d0:	57                   	push   %edi
     8d1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     8e1:	68 7a 12 00 00       	push   $0x127a
     8e6:	57                   	push   %edi
     8e7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     91d:	e8 ce 07 00 00       	call   10f0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000950 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     95f:	68 60 12 00 00       	push   $0x1260
     964:	56                   	push   %esi
     965:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     989:	68 9c 12 00 00       	push   $0x129c
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9f9:	ff 24 85 fc 12 00 00 	jmp    *0x12fc(,%eax,4)
     ...
     a85:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     aa3:	68 f1 11 00 00       	push   $0x11f1
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     ace:	52                   	push   %edx
     acf:	50                   	push   %eax
     ad0:	68 9e 12 00 00       	push   $0x129e
     ad5:	6a 02                	push   $0x2
     ad7:	e8 d4 03 00 00       	call   eb0 <printf>
    panic("syntax");
     adc:	c7 04 24 62 12 00 00 	movl   $0x1262,(%esp)
...
00000ddb <fork_winner>:
SYSCALL(fork_winner)
     ddb:	b8 18 00 00 00       	mov    $0x18,%eax
     de0:	cd 40                	int    $0x40
     de2:	c3                   	ret

00000de3 <enable_sched_trace>:
SYSCALL(enable_sched_trace)
     de3:	b8 17 00 00 00       	mov    $0x17,%eax
     de8:	cd 40                	int    $0x40
     dea:	c3                   	ret
     ...
     e18:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     e4b:	0f b6 92 74 13 00 00 	movzbl 0x1374(%edx),%edx
  ...
  write(fd, &c, 1);
     ...
     e86:	50                   	push   %eax
     e87:	56                   	push   %esi
     e88:	e8 c6 fe ff ff       	call   d53 <write>
  while(--i >= 0)
     ...
     eb9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  write(fd, &c, 1);
     ...
     ef0:	50                   	push   %eax
     ef1:	57                   	push   %edi
     ef2:	e8 5c fe ff ff       	call   d53 <write>
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     f24:	ff 24 85 1c 13 00 00 	jmp    *0x131c(,%eax,4)
  ...
  write(fd, &c, 1);
     ...
     f50:	57                   	push   %edi
     f51:	e8 fd fd ff ff       	call   d53 <write>
     ...
     f61:	52                   	push   %edx
     f62:	57                   	push   %edi
     f63:	e8 eb fd ff ff       	call   d53 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
     ...
     fdb:	53                   	push   %ebx
     fdc:	57                   	push   %edi
     fdd:	e8 71 fd ff ff       	call   d53 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    102b:	52                   	push   %edx
    102c:	57                   	push   %edi
    102d:	e8 21 fd ff ff       	call   d53 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    1050:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    1055:	bb 14 13 00 00       	mov    $0x1314,%ebx
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1061:	a1 a4 19 00 00       	mov    0x19a4,%eax
{
  ...
  freep = p;
    ...
    10a1:	5b                   	pop    %ebx
  freep = p;
    10a2:	89 15 a4 19 00 00    	mov    %edx,0x19a4
}
    10a8:	5e                   	pop    %esi
    10a9:	5f                   	pop    %edi
    10aa:	5d                   	pop    %ebp
  ...
  freep = p;
    10da:	89 15 a4 19 00 00    	mov    %edx,0x19a4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    10fc:	8b 15 a4 19 00 00    	mov    0x19a4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    113b:	39 05 a4 19 00 00    	cmp    %eax,0x19a4
    1141:	75 ed                	jne    1130 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
    1143:	83 ec 0c             	sub    $0xc,%esp
    1146:	56                   	push   %esi
    1147:	e8 6f fc ff ff       	call   dbb <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    1163:	8b 15 a4 19 00 00    	mov    0x19a4,%edx
    ...
    118c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    118f:	89 15 a4 19 00 00    	mov    %edx,0x19a4
}
    ...
    119f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    11a0:	c7 05 a4 19 00 00 a8 	movl   $0x19a8,0x19a4
    11a7:	19 00 00 
    base.s.size = 0;
    11aa:	b8 a8 19 00 00       	mov    $0x19a8,%eax
    base.s.ptr = freep = prevp = &base;
    11af:	c7 05 a8 19 00 00 a8 	movl   $0x19a8,0x19a8
    11b6:	19 00 00 
    base.s.size = 0;
    11b9:	c7 05 ac 19 00 00 00 	movl   $0x0,0x19ac
    11c0:	00 00 00 
    if(p->s.size >= nunits){
