...
0000031b <fork_winner>:
SYSCALL(fork_winner)
 31b:	b8 18 00 00 00       	mov    $0x18,%eax
 320:	cd 40                	int    $0x40
 322:	c3                   	ret

00000323 <enable_sched_trace>:
 ...
 3f9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 56b:	52                   	push   %edx
 56c:	57                   	push   %edi
 56d:	e8 21 fd ff ff       	call   293 <write>
        ap++;
 ...
 590:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 595:	bb 1e 07 00 00       	mov    $0x71e,%ebx
...
free(void *ap)
{
 ...
 5a1:	a1 1c 0a 00 00       	mov    0xa1c,%eax
{
 ...
 5e1:	5b                   	pop    %ebx
  freep = p;
 5e2:	89 15 1c 0a 00 00    	mov    %edx,0xa1c
}
 5e8:	5e                   	pop    %esi
 5e9:	5f                   	pop    %edi
 5ea:	5d                   	pop    %ebp
 ...
 617:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 61a:	89 15 1c 0a 00 00    	mov    %edx,0xa1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 1c 0a 00 00    	mov    0xa1c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67b:	39 05 1c 0a 00 00    	cmp    %eax,0xa1c
 ...
 69e:	e8 fd fe ff ff       	call   5a0 <free>
  return freep;
 6a3:	8b 15 1c 0a 00 00    	mov    0xa1c,%edx
 ...
 6cc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6cf:	89 15 1c 0a 00 00    	mov    %edx,0xa1c
}
 ...
 6df:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6e0:	c7 05 1c 0a 00 00 20 	movl   $0xa20,0xa1c
 6e7:	0a 00 00 
    base.s.size = 0;
 6ea:	b8 20 0a 00 00       	mov    $0xa20,%eax
    base.s.ptr = freep = prevp = &base;
 6ef:	c7 05 20 0a 00 00 20 	movl   $0xa20,0xa20
 6f6:	0a 00 00 
    base.s.size = 0;
 6f9:	c7 05 24 0a 00 00 00 	movl   $0x0,0xa24
 700:	00 00 00 
    if(p->s.size >= nunits){
