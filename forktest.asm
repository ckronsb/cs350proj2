  ...
  44:	31 db                	xor    %ebx,%ebx
{
  ...
  6f:	90                   	nop
    if(pid == 0)
  70:	74 5b                	je     cd <forktest+0x8d>
  for(n=0; n<N; n++){
  72:	83 c3 01             	add    $0x1,%ebx
  75:	81 fb e8 03 00 00    	cmp    $0x3e8,%ebx
  7b:	0f 84 86 00 00 00    	je     107 <forktest+0xc7>
    pid = fork();
  ...
  d5:	68 3f 04 00 00       	push   $0x43f
  da:	e8 d1 00 00 00       	call   1b0 <strlen>
  df:	83 c4 0c             	add    $0xc,%esp
  e2:	50                   	push   %eax
  e3:	68 3f 04 00 00       	push   $0x43f
  e8:	6a 01                	push   $0x1
  ea:	e8 94 02 00 00       	call   383 <write>
      exit();
  ef:	e8 6f 02 00 00       	call   363 <exit>
    printf(1, "wait got too many\n");
  f4:	50                   	push   %eax
  f5:	50                   	push   %eax
  f6:	68 53 04 00 00       	push   $0x453
  fb:	6a 01                	push   $0x1
  fd:	e8 0e ff ff ff       	call   10 <printf>
    exit();
 102:	e8 5c 02 00 00       	call   363 <exit>
    printf(1, "fork claimed to work N times!\n", N);
 107:	52                   	push   %edx
 108:	68 e8 03 00 00       	push   $0x3e8
 10d:	68 74 04 00 00       	push   $0x474
 112:	6a 01                	push   $0x1
 114:	e8 f7 fe ff ff       	call   10 <printf>
    exit();
 119:	e8 45 02 00 00       	call   363 <exit>
...
0000040b <fork_winner>:
SYSCALL(fork_winner)
 40b:	b8 18 00 00 00       	mov    $0x18,%eax
 410:	cd 40                	int    $0x40
 412:	c3                   	ret

00000413 <enable_sched_trace>:
